...
class Blended_PID_Controller():
    ...
    def update(self):
        ...
        # blended controller
            ...
            print("Agent- Roll Blending weight:" + str(roll_blend_weight[0]))
            print("Agent- Pitch Blending weight:" + str(pitch_blend_weight[0]))
    ...
    def set_action(self, action):
        ...
        print("Current Roll Dist: "+ str([action[0], action[1]]))
        print("Current Pitch Dist: "+ str([action[2], action[3]]))
